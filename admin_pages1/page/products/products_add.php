                        ...
                        <?php
                            if(isset($_COOKIE['colorid'])){ ?>
                                ...
                                <select id="select_mausanpham" name="select_mausanpham">
                                    <option value="color1" <?php if ($_COOKIE['colorid'] == 'color1') echo ' selected="selected"';  ?>>White</option>
                                    <option value="color2" <?php if ($_COOKIE['colorid'] == 'color2') echo ' selected="selected"';  ?>>Black</option>
                                    <option value="color3" <?php if ($_COOKIE['colorid'] == 'color3') echo ' selected="selected"';  ?>>Pink</option>
                                    <option value="color4" <?php if ($_COOKIE['colorid'] == 'color4') echo ' selected="selected"';  ?>>Red</option>
                                    <option value="color5" <?php if ($_COOKIE['colorid'] == 'color5') echo ' selected="selected"';  ?>>Blue</option>
                                    <option value="color6" <?php if ($_COOKIE['colorid'] == 'color6') echo ' selected="selected"';  ?>>Yellow</option>
                                    <option value="color7" <?php if ($_COOKIE['colorid'] == 'color7') echo ' selected="selected"';  ?>>Orange</option>
                                    <option value="color8" <?php if ($_COOKIE['colorid'] == 'color8') echo ' selected="selected"';  ?>>Grey</option>
                                </select>
                        </label>
                        <?php
